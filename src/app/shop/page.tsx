      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-3/4">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-8  ">
            {/* <h1 className="text-3xl font-bold mb-4 sm:mb-0 text-black">Our Shop</h1> */}
            ...
            <ul className="space-y-2">
              ...
              <Image
                ...
                <div className="text-white text-[16px] font-bold absolute mt-[-260px] ml-8">
                  ...
                  <button className="font-semibold mt-28   flex">Shop Now
              ...
              <Link href={'/'}><button className="mb-2 px-2 py-2 rounded-md shadow-md hover:underline underline-offset-8 hover:text-orange-600 transition-colors">Services</button></Link>
               ...
               <Link href={'/'}><button className="ml-1 px-2 py-2 rounded-md shadow-md hover:underline underline-off set-8 hover:text-orange-600 transition-colors">Burger</button></Link>
